<template>
  <nav class="flex max-w-7xl m-auto">
    <div class="md:w-2/5 py-3 pl-14">
      <NuxtLink to="/">
        <img src="@/static/logompio.png" class="w-full md:w-72 p-3" alt="" />
      </NuxtLink>
    </div>
        ...
        <div class="pt-28 px-6">
          <div>
            <NuxtLink
              to="/"
              @click="modal = !modal"
              class="text-white text-2xl flex"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div class="pt-28">
            <img src="@/static/logompio.png" class="w-full px-10 " alt="" />
          </div>
        </div>
      </div>
    </div>
