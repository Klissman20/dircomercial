  ...
  <div class="max-w-4xl mx-auto bg-[rgba(0,0,0,0.4)] px-8 rounded-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8">
      ...
      <div class="mt-5 md:mt-0">
        <label for="razon_social" class="w-1/3 text-white">Razón Social:</label>
        <input
          id="razon_social"
    ...
    <div class="flex gap-x-8 grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="pt-6">
        <label for="email" class="w-1/3 text-white">Correo Electrónico:</label>
        <input
          id="email"
          v-model="comercio.direccion"
          name="email"
...
/* export default {
  ...
  computed: {
    fields() {
      return Object.keys(this.comercio);
    },
  },
  mounted() {
    const { id } = this.$route.query;
    // eslint-disable-next-line no-console
    if (id) this.getComercio(parseInt(id));
  },
  methods: {
